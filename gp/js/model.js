            ...
            `div`, `._gA0 _gW0`, `&@style>padding:16px`, [[
              `div`, `.@_gY`, [[
                `div`, `.@_geQ _aXZ _gxM`, `&@style>padding:5px 0;min-height:38px`, [[
                  ...
                  `div`, `.@_gZz`, [[
                    `div`, [[
                      `a`, `.@_-tX ${(Row.pws_md === false)? `Geo_1185FE`: `Geo_EEDF00`}`, `&@href>${(Row.mall_md && Row.mall_md.length > 6)? `/mall/${Row.mall_md}/`: `javascript:;`}`, `&@style>width:12px;height:12px`]]], [
                    `div`, [[`span`, `&@style>margin-left:5px;font-family:gotham-book;font-size:10.5px;letter-spacing:normal;font-weight:600`, `~@${(Row.miles).toFixed(2)} mi`]]]]]]], [
                `a`, `.@_Qg`, [[
                  `div`, `.@_Qg0 _geQ`, [[
                    `img`, `&@sum>${Row.MD5}`, `&@alt>${Row.alpha}`, `&@style>max-width:140px`, `&@src>/${Row.files[0]}`]]]], `&@href>/item/${Row.MD5}/`], [
                `div`, [[
                  `div`, `.@_pY`, `&@style>padding:16px 0 0`, [[
                    ...
                    `div`, `.@_gcQ _aXZ _yZS`, [[`span`, `.@-_tX v3`], [
                      `div`, `.@_eYG _gxM _a2X`, [[
                        `span`, `&@style>text-overflow:ellipsis;overflow:hidden;white-space:nowrap;color:#47008c`, `~@${(Row.set === `beverages` || Row.set === Models.Filter(`corrde eat & dine`) || Row.set === Models.Filter(`fruits & vegetables`))? `free delivery`: `${Fx[UA.get().area][1] + `` + Row.mailing} (shipping)`}`]]]]]]]]], [
            `div`, `.@-Zz`, `&@style>position:absolute;bottom:0;right:0;border-radius: 12px 0 0 0;background:rgba(0,0,0,.75);color:#fff`, [[
              `div`, `.@${(Seen[Row.MD5].items && Seen[Row.MD5].items > 0)? ``: `_-Zz`}`, [[
                `a`, `#@min`, `.@alterCart Min`, data, `&@href>javascript:;`], [
                `span`, `&@style>text-align:center;font-family:gotham-book`, `~@${(Seen[Row.MD5].items)? ((Seen[Row.MD5].items < 10)? `0`+ Seen[Row.MD5].items: Seen[Row.MD5].items): `00`}`]]], [
  ...
  ModelCart () {
    ...
    for (let Port in Ports) {
      ...
      Ports[Port].forEach(P => {
        ...
        if (P.set.match(`beverages`) || P.set.match(`corrde eat`) || P.set.match(`fruits`)) P.mass = 0;
      ...
      ModelPorts.push([
        `div`, `.@_gxM _yZS`, [[
          `div`, `.@_aXZ`, [[
            `div`, `.@_gxM`, [[
              `span`, `.@_tXx`, `&@style>text-transform:capitalize;`, `~@${(Ports[Port][0].float)? Ports[Port][0].float[0][0]: `kisumu`} store`], [
      ...
      `div`, `.@_-tY`, [[
        `div`, `.@_aXz`, [[
          ...
          `div`, `.@_QZg`, `&@style>font-family:gotham-med;text-transform:uppercase`, [[
            ...
            `span`, `~@${FX[1]}${(UA.get().payOld*FX[0]).toFixed(2)}`]]]]]]], [
            ...
            `div`, `.@_gA0 _gW0`, `&@style>width:${100/Column}%;padding:16px`, [[
              `div`, `.@_gY`, [[
                `div`, `.@_geQ _aXZ _gxM`, `&@style>padding:5px 0`, [[
                  ...
                  `div`, `.@_QZg`, [[
                    `a`, `.@_-tX ${(Row.pws_md === false)? `Geo_1185FE`: `Geo_EEDF00`}`, `&@href>${(Row.mall_md && Row.mall_md.length > 6)? `/mall/${Row.mall_md}/`: `javascript:;`}`, `&@style>width:19px;height:19px`], [
                    `div`, [[`span`, `&@style>margin-left:5px;font-family:gotham-book;font-weight:600;font-size:10px;letter-spacing:normal;`, `~@${(Row.miles).toFixed(2)}mi`]]]]]]], [
                `a`, `.@_Qg`, [[
                  `div`, `.@_Qg0 _geQ`, [[
                    `img`, `&@sum>${Row.MD5}`, `&@alt>${Row.alpha}`, `&@style>max-width:140px`, `&@src>/${Row.files[0]}`]]]], `&@href>/item/${Row.MD5}/`], [
                `div`, [[
                  `div`, `.@_pY`, `&@style>padding:16px 0 0`, [[
                    ...
                    `a`, `#@pullRetailStock`, `&@sum>${Row.MD5}`, `.@_a2`, [[
                      `span`, `.@_aA2`, `&@style>line-height:22px;-moz-orient:vertical;display:-webkit-box;overflow:hidden;-webkit-line-clamp:3;font-size:12px;text-transform:capitalize;display:block;white-space:nowrap;text-overflow:ellipsis`, `~@${Row.alpha}`]], `&@href>javascript:;`]]], [
                    `div`, `.@_gcQ _aXZ _yZS`, [[`span`, `.@-_tX v3`], [
                      `div`, `.@_eYG _gxM _a2X`, [[`span`, `.@_tXx`, `~@${(Row.set === `beverages` || Row.set === Models.Filter(`corrde eat & dine`) || Row.set === Models.Filter(`fruits & vegetables`))? `free delivery`: `${Fx[UA.get().area][1] + `` + Row.mailing} (shipping)`}`]]]]]]]]], [
            `div`, `.@-Zz`, `&@style>position:absolute;bottom:0;right:0;border-radius: 12px 0 0 0;background:rgba(0,0,0,.75);color:#fff`, [[
              `div`, `.@${(Seen[Row.MD5].items && Seen[Row.MD5].items > 0)? ``: `_-Zz`}`, [[
                `a`, `#@min`, `.@alterCart Min`, data, `&@href>javascript:;`], [
                `span`, `&@style>text-align:center;font-family:gotham-book`, `~@${(Seen[Row.MD5].items)? ((Seen[Row.MD5].items < 10)? `0`+ Seen[Row.MD5].items: Seen[Row.MD5].items): `00`}`]]], [
                ...
                `a`, `.@_Qg`, `&@style>height:calc(50vh)`, [[
                  ...
                  `div`, `.@_gZ _gxM _yZS`, `@style>padding:16px 0`, [[
                    ...
                    `div`, `.@_eYG`, [[
                      ...
                      `div`, `.@_gxM _geQ`, `&@style>width:100%`, [[
                        `div`, [[
                          `span`, `.@_a2X`, `&@style>color:#47008c`, `~@${(Sell.set === `beverages` || Sell.set === Models.Filter(`corrde eat & dine`) || Sell.set === Models.Filter(`fruits & vegetables`))? `free delivery`: `${Fx[UA.get().area][1] + `` + Sell.mailing} (shipping)`}`]]], [
                        `div`, `.@_QZg`, [[
                        `a`, `.@_-tX ${(Sell.pws_md === false)? `Geo_1185FE`: `Geo_EEDF00`}`, `&@href>${(Sell.mall_md && Sell.mall_md.length > 6)? `/mall/${Sell.mall_md}/`: `javascript:;`}`, `&@style>width:12px;height:12px`], [
                          `div`, [[`span`, `&@style>margin-left:5px;font-family:gotham-book;font-weight:600;font-size:10.5px;letter-spacing:normal;`, `~@${(Sell.miles).toFixed(2)} mi`]]]]]]]]]]], [
                  `div`, `.@_gZ`]]]]]]]]]]];
  },
              ...
              `div`, `.@_gY`, [[
                `div`, `.@_geQ _aXZ _gxM`, `&@style>padding:5px 0;min-height:38px`, [[
                  ...
                  `div`, `.@_gZz`, [[
                    `div`, [[
                      `a`, `.@_-tX ${(Row.pws_md === false)? `Geo_1185FE`: `Geo_EEDF00`}`, `&@href>${(Row.mall_md && Row.mall_md.length > 6)? `/mall/${Row.mall_md}/`: `javascript:;`}`, `&@style>width:12px;height:12px`]]], [
                    `div`, [[`span`, `&@style>margin-left:5px;font-family:gotham-book;font-weight:600;font-size:10.5px;letter-spacing:normal;`, `~@${(Row.miles).toFixed(2)} mi`]]]]]]], [
                `a`, `.@_Qg`, [[
                  `div`, `.@_Qg0 _geQ`, [[
                    `img`, `&@sum>${Row.MD5}`, `&@alt>${Row.alpha}`, `&@style>max-width:140px`, `&@src>/${Row.files[0]}`]]]], `&@href>/item/${Row.MD5}/`], [
                `div`, [[
                  `div`, `.@_pY`, `&@style>padding:16px 0 0`, [[
                    ...
                    `a`, `#@pullRetailStock`, `&@sum>${Row.MD5}`, `.@_a2`, [[
                      `span`, `.@_aA2`, `&@style>line-height:22px;-moz-orient:vertical;display:-webkit-box;overflow:hidden;-webkit-line-clamp:3;font-size:12px;text-transform:capitalize;display:block;white-space:nowrap;text-overflow:ellipsis`, `~@${Row.alpha}`]], `&@href>javascript:;`]]], [
                    `div`, `.@_gcQ _aXZ _yZS`, [[`span`, `.@-_tX v3`], [
                      `div`, `.@_eYG _gxM _a2X`, [[`span`, `&@style>text-overflow:ellipsis;overflow:hidden;white-space:nowrap;color:#47008c`, `~@${(Row.set === `beverages` || Row.set === Models.Filter(`corrde eat & dine`) || Row.set === Models.Filter(`fruits & vegetables`))? `free delivery`: `${Fx[UA.get().area][1] + `` + Row.mailing} (shipping)`}`]]]]]]]]], [
            `div`, `.@-Zz`, `&@style>position:absolute;bottom:0;right:0;border-radius: 12px 0 0 0;background:rgba(0,0,0,.75);color:#fff`, [[
              `div`, `.@${(Seen[Row.MD5].items && Seen[Row.MD5].items > 0)? ``: `_-Zz`}`, [[
                `a`, `#@min`, `.@alterCart Min`, data, `&@href>javascript:;`], [
                `span`, `&@style>text-align:center;font-family:gotham-book`, `~@${(Seen[Row.MD5].items)? ((Seen[Row.MD5].items < 10)? `0`+ Seen[Row.MD5].items: Seen[Row.MD5].items): `00`}`]]], [
        ...
        ModelBoolean = [
          ...
          `div`, `.@_gxM _geQ`, [[
            ...
            `div`, `.@_eYG`, [[
              ...
              `div`, `&@style>width:100%`, [[
                `span`, `.@_tXx`, `&@style>letter-spacing:normal;font-family:gotham-book;font-size:10px;text-transform:uppercase;white-space:nowrap;text-overflow:ellipsis;overflow:hidden`, `~@delivers by ${new Date(Sec[3]).getDate()} ${Month[new Date(Sec[3]).getMonth()].substring(0, 3)} ${new Date(Sec[3]).getHours()}:00`]]]]], [
            `div`, `.@_gZz`, [[
              `div`, `.@_gM_a _agM _guZ`, `&@style>background:#1185fe;max-width:max-content`, [[
        ...
        `div`, `.@_gZ _gxM _geQ`, [[
          `div`, `.@_gZ _gxM _geQ`, `&@style>padding:16px 0`, [[
            ...
            `section`, `.@_-Zz`, `&@style>width:100%;`, [[
              `div`, `.@_g0`, `&@style>`, [[
                `div`, `.@_gX0`, `&@style>max-width:960px;margin:0 auto;width:100%`, [[
                  `div`, `.@`, [[`span`, `.@_tXx`, `&@style>font-family:gotham-book;color:#1185fe;padding:0 0 16px`, `~@$${((MD.dollars)/*/this.Fx[`kenya`][0]*/).toFixed(2)} USD`]]], [
                  `div`, `&@style>padding-bottom:16px`, ModelFlow], [
